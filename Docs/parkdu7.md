...
# 2025.11.03
- arfni-plugins 레포 플러그인 추가 시 자동 리스트 업데이트 구현

# 2025.11.04
- 기존 하드코딩 되어있던 기본 제공 스택들 플러그인화
- 대규모 수정이 있었던 만큼 merge conflict가 많아 병합 후 테스트 진행

# 2025.11.05
- 이 플러그인 merge conflict 및 병합과정에서 나는 에러 모두 수정해서 develop 브랜치에 올림
